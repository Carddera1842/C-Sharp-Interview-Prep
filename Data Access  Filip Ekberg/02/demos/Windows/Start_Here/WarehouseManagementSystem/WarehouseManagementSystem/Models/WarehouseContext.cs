    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) {
        ...
        if (!optionsBuilder.IsConfigured)
        {
            ...
            optionsBuilder.UseSqlServer(
                ...
                "AttachDbFilename=C:\\Users\\admin\\Desktop\\C-Sharp-Interview-Prep\\Data Access  Filip Ekberg\\02\\demos\\Windows\\Start_Here\\WarehouseManagement.mdf;Integrated Security = True; Connect Timeout = 30"
            );
        }
